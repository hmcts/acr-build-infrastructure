...
| <a name="input_sds_acr"></a> [sds\_acr](#input\_sds\_acr) | SDS ACR to be created | <pre>map(object({<br/>    sku                    = string<br/>    admin_enabled          = bool<br/>    anonymous_pull_enabled = optional(bool, false)<br/>  }))</pre> | n/a | yes |
| <a name="input_sds_resource_group_name"></a> [sds\_resource\_group\_name](#input\_sds\_resource\_group\_name) | Name of the resource group | `string` | `"sds-acr-rg"` | no |
| <a name="input_sds_subscription_id"></a> [sds\_subscription\_id](#input\_sds\_subscription\_id) | Subscription ID for SDS | `string` | n/a | yes |
